...
class Main extends Controller
{
   ...
   function terlaris_user($id_user)
   {
      $bj = $this->model("Get")->cols_where_groubBy_orderBy("barang_jual", "id_barang, id_user, SUM(jumlah) as jumlah", "id_master = '" . $this->userData['id_master'] . "' AND id_user = '" . $id_user . "' AND op_status = 1", "id_barang, id_user", "id_user ASC");
      $bp = $this->model("Get")->cols_where_groubBy_orderBy("barang_pakai", "id_barang, id_user, SUM(jumlah) as jumlah", "id_master = '" . $this->userData['id_master'] . "' AND id_user = '" . $id_user . "' AND op_status = 1", "id_barang, id_user", "id_user ASC");
      $new = [];
