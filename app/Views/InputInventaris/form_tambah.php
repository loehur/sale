...
<div class="content" id="form_tambah">
    <div class="container-fluid">
        <div class="row">
            <div class="col-auto mr-auto">
                <form class="tambah" action="<?= $this->BASE_URL . $this->ACTIVE_CONTROLLER ?>/tambah_stok/<?= $data['id'] ?>" method="post">
                    <div class="row mb-2">
                        <div class="col">
                            <input type="text" class="form-control form-control-sm" name="posisi" placeholder="Posisi (Optional)">
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col">
...
<script>
    $(document).ready(function() {
        ...
        $('button#barang_edit').click(function() {
            ...
            $("div#load").load("<?= $this->BASE_URL . $this->ACTIVE_CONTROLLER ?>/barang_edit/" + kode);
        });
    });
</script>